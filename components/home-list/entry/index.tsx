    ...
    <div className={styles.entry}>
      ...
      <div className={styles['content-wrapper']}>
        <div className={styles.main}>
          ...
          <div className={styles['action-list ']}>action-list </div>
        </div>

        <Image src="https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/8c511a17b46143b3918913762839f93d~tplv-k3u1fbpfcp-no-mark:240:240:240:160.awebp"
          width={120}
          height={80}
          alt="" />
      </div>
